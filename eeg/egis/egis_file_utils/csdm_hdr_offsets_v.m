%csdm_hdr_offsets.m
%
% 1/9/96  PJ & RS Appropriating BytOrd field to write length of CSDM file
%         headers.  Using old LHeader field for NOffset.
%
...
LHeader_CSDM = 1;   % Used to be BytOrd=1;
HdrVer=2;
NOffset=3;    % Used to be LHeader=3;
LData=4;
LHeader = 3;
