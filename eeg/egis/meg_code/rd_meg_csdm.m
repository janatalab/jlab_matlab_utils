function [ravgcsdm,iavgcsdm] = rd_meg_csdm(csdmfname);
%
% reads the csdmmatrix
%
...
ravgcsdm = fread(csdmfid,[NChan_file,nfreq],'real*4');
ravgcsdm = ravgcsdm';
iavgcsdm = fread(csdmfid,[NChan_file,nfreq],'real*4');
iavgcsdm = iavgcsdm';
fclose(csdmfid);
