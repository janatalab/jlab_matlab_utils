function [stim_id_str,stim_id,stimloc] = get_ensemble_weighted_stim_v2(varargin)

% [stim_id_str,stim_id,stimloc] = get_ensemble_weighted_stim_v2(varargin);
%
...
script_version = 'get_ensemble_weighted_stim_v2.0';
