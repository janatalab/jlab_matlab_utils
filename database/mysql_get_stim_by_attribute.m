...
mysql_str = sprintf(['SELECT %s FROM stimulus, attribute, stimulus_x_attribute ' ...	
	'WHERE stimulus.stimulus_id = stimulus_x_attribute.stimulus_id ' ...
	'AND attribute.attribute_id = stimulus_x_attribute.attribute_id ' ...
	'AND attribute.name IN (%s);'], extract_vars_str, attrib_name_str);
