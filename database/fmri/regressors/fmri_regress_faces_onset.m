function [names,vals] = fmri_regress_faces_onset(pinfo,minfo,sess)

% generates fmri data regressors for onset of facial affect stimuli
% 
%   [names,vals] = fmri_regress_faces_onset(pinfo,minfo,sess)
% 
